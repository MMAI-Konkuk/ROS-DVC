...
rosdvc_dir = dirname(dirname(abspath(__file__)))
sys.path.append(rosdvc_dir)
sys.path.append(os.path.join(rosdvc_dir, 'densevid_eval3/SODA'))
...
if __name__ == '__main__':
    ...
    p_new = '../save/old/cfgs--base_config_v2_0427--anet_c3d_rosdvc_seed358/2021-08-21-21-47-13_debug_2021-08-21_20-46-20_epoch8_num4917_score0_top1000.json'
    p_vitr= '../save/old/cfgs--base_config_v2_0427--anet_c3d_e2dvc_seed358/2021-08-21-21-47-20_cfgs--base_config_v2_0427--anet_c3d_e2dvc_seed358_epoch8_num4917_score0_top1000.json.tmp'
