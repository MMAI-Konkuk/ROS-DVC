...
def main(opt):
    ...
    if opt.eval_mode == 'test':
        ...
        opt.visual_feature_folder = old_opt.get('visual_feature_folder')
    ...
    if opt.eval_mode == 'test':
        ...
        evaluate(model, memory_bank, criterion, postprocessors, loader, out_json_path,
        ...
        out_json_path = os.path.join(folder_path, '{}_epoch{}_num{}_alpha{}.json'.format(
            ...
            opt.ec_alpha))
        caption_scores, eval_loss = evaluate(model, memory_bank, criterion, postprocessors, loader, out_json_path,
...
if __name__ == '__main__':
    ...
    #parser.add_argument('--eval_caption_file', type=str, default='data/yc2/captiondata/yc2_val.json')
