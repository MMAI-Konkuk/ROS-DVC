...
class HungarianMatcher(nn.Module):
    ...
    def forward(self, outputs, targets, verbose=False, many_to_one=False):
        ...
        with torch.no_grad():
            ...
            # Final cost matrix
            C = self.cost_bbox * cost_bbox + self.cost_class * cost_class + self.cost_giou * cost_giou + self.cost_caption * cost_caption
...
def build_matcher(args):
    return HungarianMatcher(cost_class=args.set_cost_class,
                            ...
                            cost_caption=args.set_cost_caption,
