...
def parse_opts():
    ...
    parser.add_argument('--visual_feature_type', type=str, default='clip', choices=['clip'])
    ...
    parser.add_argument('--osl_beta', default=1., type=float)
    ...
    #*******************************contrastive loss ******************************
    parser.add_argument('--ctca_loss_temperature', type=float, default=0.15 , help='Temperature of cl temperature')
    
    #******************************* concept args ******************************
    parser.add_argument('--concept_stoi_file', type=str, default='data/yc2/yc2_concept_vocab.json')
    parser.add_argument('--concept_num', type=int, default=30)
